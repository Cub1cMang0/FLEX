    ...
    , ui(new Ui::MainWindow)
{
    ...
    QStringList dirs = {
        ...
        QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation) + "/error_logs"
    };
    ...
    connect(ui->actionOpen_Error_Folder, &QAction::triggered, this, &MainWindow::open_error_location);
...
void MainWindow::open_error_location()
{
    QDesktopServices::openUrl(QUrl::fromLocalFile(QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation) + "/error_logs"));
}
